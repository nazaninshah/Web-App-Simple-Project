package com.example.shahbazi.securitypractice.config;

import ch.qos.logback.core.util.StringUtil;
import com.example.shahbazi.securitypractice.services.JWTService;
import com.example.shahbazi.securitypractice.services.UserService;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        userMail = jwtService.extarctUserName(jwt);

        if(!StringUtils.isEmpty(userMail) && SecurityContextHolder.getContext().getAuthentication() == null) {
